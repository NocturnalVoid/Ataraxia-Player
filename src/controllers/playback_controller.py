...
class PlaybackController(QObject):
    ...
    def set_dsp_settings(self, settings: dict):
        ...
        if self.current_queue and self.current_index != -1:
            ...
            self.load_track(self.current_queue[self.current_index], auto_play=was_playing)
    ...
    def load_track(self, filepath: str, auto_play: bool = True):
        try:
            self._load_track_impl(filepath, auto_play)
        except Exception:
    ...
    def _load_track_impl(self, filepath: str, auto_play: bool = True):
        self._has_counted_play = False 
