...
class PreferencesDialog(QDialog):
    ...
    def _setup_maintenance_tab(self):
        ...
        self.lbl_maintenance_status.setWordWrap(True)
        # El stylesheet inicial se aplica con el color resuelto desde el
        # palette del widget. Esto evita que el label aparezca con texto
        # negro sobre fondo oscuro al abrirse antes de la primera llamada
        # a _show_status (que recalcula el color).
    ...
    def _on_export_backup(self):
        ...
        try:
            ...
            if ok:
                self._show_status(f"✓ Respaldo guardado en: {path}", success=True)
            else:
                self._show_status(
