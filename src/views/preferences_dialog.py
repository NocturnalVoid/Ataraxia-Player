...
class PreferencesDialog(QDialog):
    ...
    def _load_current_settings(self):
        # Default: el path resuelto automáticamente (instalador embebido,
        # raíz del proyecto, PATH del sistema, en ese orden).
        from src.utils.ffmpeg_locator import get_ffmpeg_path
        ffmpeg_path = self.settings.value("ffmpeg_path", get_ffmpeg_path())
